              ...
              <div className='mt-2 sm:mx-auto sm:w-full sm:max-w-sm'>
                <div className='space-y-6'>
                  ...
                  <div>
                    <button
                      onClick={() => login()}
                      className='hover:cursor-pointer flex w-full justify-center rounded-md bg-indigo-600 px-3 py-1.5 text-sm/6 font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-offset-2 focus-visible:outline-blue-600'
                    >
                      Log In
                    </button>
                  </div>
